...
* [SequenceConstructionOptions](globals.md#sequenceconstructionoptions)
* [dataRecord](globals.md#datarecord)
* [friendData](globals.md#frienddata)

### Variables

* [data](globals.md#let-data)
* [performance](globals.md#performance)

### Functions

* [allDemo](globals.md#let-alldemo)
* [anyDemo](globals.md#let-anydemo)
* [appendDemo](globals.md#let-appenddemo)
* [concatDemo](globals.md#let-concatdemo)
* [elementAtDemo](globals.md#let-elementatdemo)
* [elementAtOrDefaultDemo](globals.md#let-elementatordefaultdemo)
* [emptyDemo](globals.md#let-emptydemo)
* [from](globals.md#from)
* [rangeDemo](globals.md#let-rangedemo)
* [selectDemo](globals.md#let-selectdemo)
...
*Defined in [interfaces.ts:12](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/interfaces.ts#L12)*
...
*Defined in [interfaces.ts:31](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/interfaces.ts#L31)*
...
###  SequenceConstructionOptions

Ƭ **SequenceConstructionOptions**: *object*

*Defined in [Sequence.ts:3](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/Sequence.ts#L3)*
...
*Defined in [data.ts:5](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/data.ts#L5)*
...
* **friends**: *[friendData](globals.md#frienddata)[]*
...
*Defined in [data.ts:1](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/data.ts#L1)*
...
• **data**: *[dataRecord](globals.md#datarecord)[]* = [
    {
...
*Defined in [data.ts:30](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/data.ts#L30)*
...
*Defined in [main.ts:4](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/main.ts#L4)*
...
*Defined in [main.ts:7](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/main.ts#L7)*
...
*Defined in [main.ts:18](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/main.ts#L18)*
...
*Defined in [main.ts:49](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/main.ts#L49)*
...
*Defined in [main.ts:62](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/main.ts#L62)*
...
*Defined in [main.ts:88](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/main.ts#L88)*
...
▸ **elementAtOrDefaultDemo**(): *void*

*Defined in [main.ts:95](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/main.ts#L95)*
...
*Defined in [main.ts:106](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/main.ts#L106)*
...
*Defined in [Sequence.ts:14](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/Sequence.ts#L14)*
...
*Defined in [main.ts:114](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/main.ts#L114)*
...
*Defined in [main.ts:127](https://github.com/DreadLordMikey/jlinq/blob/938cb3d/src/main.ts#L127)*
